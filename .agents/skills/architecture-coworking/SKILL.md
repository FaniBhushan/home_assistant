...
# Architecture Coworking Skill

This skill guides the process of collaborative architectural design, component modeling, and interface definition between the C++ Daemon, Python Agent, and user-facing dashboards.

## Core Architectural Principles

1. **Local-First & Offline**: Avoid cloud dependencies. All data, logic, and models must run locally.
2. **Modularity & Decoupling**: Keep components isolated (e.g., C++ handles system telemetry and IO, Python handles LLM orchestrator, iPad/Web client handles the view layer).
